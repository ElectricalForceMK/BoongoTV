...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR darkcyan]Zadar [/COLOR]Wizard'
BUILDERNAME = 'Zadar Wizard'
EXCLUDES = [ADDON_ID, 'repository.ZadarHRrepo']
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Zadar[/B][/COLOR][COLOR {color2}]Team Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing The Zadar Wizard.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR darkcyan]Zadar [/COLOR]Wizard'
