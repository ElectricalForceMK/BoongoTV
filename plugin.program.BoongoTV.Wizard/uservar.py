...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR mediumblue][B]BoongoTV[/B][/COLOR] [COLOR red][B]Wizard[/B][/COLOR]'
BUILDERNAME = 'BoongoTV.Wizard'
EXCLUDES = [ADDON_ID, 'repository.BoongoTVRepo']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/ElectricalForceMK/Svasta/master/Build.txt'
# How often you would like it to check for build updates in days
# 0 being every startup of kodi
UPDATECHECK = 0
# Text File with apk info in it.  Leave as 'http://' to ignore
APKFILE = 'https://raw.githubusercontent.com/ElectricalForceMK/Svasta/master/APK-Download.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]BoongoTV[/B][/COLOR][COLOR {color2}]Wizard by ElectricalForce[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'The Future Of Home EntertainmentKodi Repository for BoongoTV by ElectricalForce Repo allows you to install the BoongoTV WIZARD where you can get access to the latest BoongoTV Custom Builds and more.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR mediumblue][B]BoongoTV[/B][/COLOR] [COLOR red][B]Wizard[/B][/COLOR]'
# url to image if using Image 424x180
HEADERIMAGE = 'http://'
# Font for Notification Window
FONTSETTINGS = 'Font13'
# Background for Notification Window
BACKGROUND = 'https://raw.githubusercontent.com/ElectricalForceMK/Svasta/master/fanart.jpg'
#########################################################
